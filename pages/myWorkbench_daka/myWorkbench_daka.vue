<template>
	<view>
		...
		<view class="dakaJilu pdlr4">
			<view class="item" v-for="(item,index) in mainData">
				...
				<view class="font13 line">
					...
					<view class="pic" @click="previewImage(index)">
		...
		<view class="fabubtn" style="top: 45%;" v-if="todayData.length>0&&type==1&&todayData.off_time!=0" @click=" Router.navigateTo({route:{path:'/pages/myWorkbench_daka_goOff/myWorkbench_daka_goOff?id='+todayData[0].id}})">
			<view class="icon">
