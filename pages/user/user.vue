	...
	<view>
		...
		<view class="userBox2 boxShaow">
			<view class="flexRowBetween tit">
				<view>我的订单</view>
				<view class="more" @click="webSelf.$Router.navigateTo({route:{path:'/pages/myOderList/myOderList'}})">全部订单 &gt;</view>
			</view>
			<view class="menu flexRowBetween">
				<view class="child" @click="webSelf.$Router.navigateTo({route:{path:'/pages/myOderList/myOderList'}})">
		...
		<view class="XlineNav">
			<view class="info" @click="webSelf.$Router.navigateTo({route:{path:'/pages/myToolingOrder/myToolingOrder'}})" >
			...
			<view class="info"  @click="webSelf.$Router.navigateTo({route:{path:'/pages/myNeeds/myNeeds'}})" >
				<view class="ilblock listimg">
			...
			<view class="info"  @click="webSelf.$Router.navigateTo({route:{path:'/pages/myCollection/myCollection'}})">
				<view class="ilblock listimg">
			...
			<view class="info"  @click="webSelf.$Router.navigateTo({route:{path:'/pages/myFootprint/myFootprint'}})">
				<view class="ilblock listimg">
			...
			<view class="info" @click="webSelf.$Router.navigateTo({route:{path:'/pages/myEvaluate/myEvaluate'}})">
				<view class="ilblock listimg">
			...
			<view class="info" @click="webSelf.$Router.navigateTo({route:{path:'/pages/myExtend/myExtend'}})">
				<view class="ilblock listimg">
			...
			<view class="info" @click="webSelf.$Router.navigateTo({route:{path:'/pages/myBusinessRegister/myBusinessRegister'}})">
				<view class="ilblock listimg">
